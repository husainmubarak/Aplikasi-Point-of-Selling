...
public class AplikasiKasirPOS extends JFrame {
    ...
    private void cariDetailProduk() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Simpan harga tanpa format, hanya angka
    ...
    private void tambahKeKeranjang() {
        try {
            ...
            // Ambil harga langsung tanpa parsing format
            ...
            JOptionPane.showMessageDialog(this, "Input tidak valid! Error: " + e.getMessage());
        }
    }
    ...
    private void hitungKembalian() {
        try {
            ...
            // Hapus semua format jika user input dengan format
            bayarText = bayarText.replace("Rp", "").replace(".", "").replace(",", ".").trim();
    ...
    private void prosesPembayaran() {
        ...
        try {
            ...
            for (int i = 0; i < modelKeranjang.getRowCount(); i++) {
                ...
                // Parse harga dari format "Rp 12.000,00"
                ...
                // Parse subtotal dari format "Rp 24.000,00"
                String subtotalStr = modelKeranjang.getValueAt(i, 4).toString()
                                     .replace("Rp ", "").replace(".", "").replace(",", ".").trim();
